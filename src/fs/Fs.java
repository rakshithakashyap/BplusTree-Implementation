...
no1=0;
try {
          File fle = new File("C:\\Users\\Rakshitha.R\\Dropbox\\My PC (Rakshitha)\\Desktop\\pbl\\fsproject_5\\src\\bplus.txt");
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader("C:\\Users\\Rakshitha.R\\Dropbox\\My PC (Rakshitha)\\Desktop\\pbl\\fsproject_5\\src\\bplus.txt"))) {
        String line;
...
for(int i=0;i<no;i++)
recs[i]=new records();
BufferedReader bbr = new BufferedReader(new FileReader("C:\\Users\\Rakshitha.R\\Dropbox\\My PC (Rakshitha)\\Desktop\\pbl\\fsproject_5\\src\\bplus.txt"));
for(int i=0;i<no;i++)
{
